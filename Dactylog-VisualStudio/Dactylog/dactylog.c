...
#include "util.h"                   // la librairie utilitaire g�n�rale
...
// programme principal de gestion de la machine � �tats (mode)
int programme_principal(void)
{

	WINDOW* fenetre[NB_ZONE];       // r�f�rence aux fen�tres "graphiques"
	int mode = MODE_COMMENCER;        // mode initial de la machine � �tats
	...
	// machine � �tat qui g�re le passage d'un mode � l'autre (modes principaux)
	do {
		switch (mode) {
		case MODE_COMMENCER:
